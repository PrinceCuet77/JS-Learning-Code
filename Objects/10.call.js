...
// But can do the following line. Because 'call' function runs instantly.
...
// Basically, using 'call' function, I am changing the pointing object of 'this' inside the specific function.
greet.call(john)
// Output:
// { name: 'john', age: 22 }
...
// Scenario: 3
susan.greet.call({ name: 'Prince', age: 20 })
// Output:
// { name: 'Prince', age: 20 }
